...
sigma_l= 12.5; % Fill-in: The standard-deviation of the low-pass filter. Range 5-20.
...
sigma_h= 12.5; % Fill-in: The standard-deviation of the high-pass filter. Range 5-20.
HighPass = fspecial('gaussian', [m n], sigma_h); 
% Fill-in: Create HighPass_f which is the inverted and normalized version
% of HighPass.
HighPass = max(HighPass) - HighPass
HighPass_f = HighPass/(sum(HighPass(:)));
figure(5);
...
weight=  0.1;% Fill-in: find a suitable weight which makes the result look good. Range (0,0.2]
