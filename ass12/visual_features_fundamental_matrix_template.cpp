...
void find_transform(Mat& F_left_right, 
	...
	Mat Sig(3, 3, CV_64FC1, Scalar(0.));
	Mat Ut(3, 3, CV_64FC1, Scalar(0.));
	Mat Wt(3, 3, CV_64FC1, Scalar(0.));
	

	W.at<double>(0, 0) = 0; W.at<double>(0, 1) = -1; W.at<double>(0, 2) = 0;
	W.at<double>(1, 0) = 1; W.at<double>(1, 1) = 0; W.at<double>(1, 2) = 0;
	W.at<double>(2, 0) = 0; W.at<double>(2, 1) = 0; W.at<double>(2, 2) = 1;

	Sig.at<double>(0, 0) = 1; Sig.at<double>(0, 1) = 0; Sig.at<double>(0, 2) = 0;
	Sig.at<double>(1, 0) = 0; Sig.at<double>(1, 1) = 1; Sig.at<double>(1, 2) = 0;
	Sig.at<double>(2, 0) = 0; Sig.at<double>(2, 1) = 0; Sig.at<double>(2, 2) = 0;
	...
	Mat tcross1 = U * W * Sig * Ut;
	Mat tcross2 = U * Wt * Sig * Ut;

	t1.at<double>(0, 0) = tcross1.at<double>(2, 1);
	t1.at<double>(1, 0) = tcross1.at<double>(0, 2);
	t1.at<double>(2, 0) = tcross1.at<double>(1, 0);

	t2.at<double>(0, 0) = tcross2.at<double>(2, 1);
	t2.at<double>(1, 0) = tcross2.at<double>(0, 2);
	t2.at<double>(2, 0) = tcross2.at<double>(1, 0);
