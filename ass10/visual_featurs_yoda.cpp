...
int main(int argc, char** argv)
{
	...
	// Ptr<FeatureDetector> detector= FeatureDetector::create("SURF"); // SIFT, SURF, HARRIS, GFTT
	...
	*/
	...
	//SurfDescriptorExtractor extractor;// doesnt work

	// Ptr<DescriptorExtractor> extractor1 = DescriptorExtractor::create("SIFT");
	...
	Mat mask;
	Mat H = findHomography(obj, scene, CV_RANSAC, 1, mask);//increasing here will have more points to be matched
	...
	drawMatches(img_object_color, keypoints_object, img_scene_color,
              	keypoints_scene, good_matches, img3, Scalar::all(-1),
              	Scalar::all(-1), mask,
